...
function ventilation_initUI() {
    ...
    for (z in data.ventilation.EVP) {
        ...
        out += '<span class="revert-to-original" item-id="' + item.id + '" item-type="ventilation-EVP" style="margin-left:15px; display:inline-block;cursor: pointer"><img src="' + path + '/static/undo.gif" style="width:14px" /><span class="text" /></span>';
        out += '</td></tr> ';
        $('#EVP').append(out);
